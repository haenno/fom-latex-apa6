...
% https://golatex.de/and-anstatt-und-bei-zitationen-t17576,start,10.html 

% Nötige Daten für Zitationen im Textteil: Nachnamen, Erscheinungsjahre, Besonderheiten: 
%  - Bei mehr als 6 Autoren: immer nur 1. Autor und "et al."   erl.
%  - Bei 3 bis 6 Autoren: Beim 1. nennen alle Nachnamen, danach nur noch 1. Autor und "et al." erl.
%  - Bei bis zu zwei Autoren, immer Nennung aller bzw. beider erl.
%  - Trennzeichen: Immer Komma, letzte Nachnamen mit "und", bsp: (Müller, Meier, Weber und Schmidt, 2018) TODO!
...
\usepackage[
	...
	\DeclareFieldFormat[online]{autor}{#1\nopunct{autor}} % 'Autor/online' Ohne Punkt am Ende -leider funktionslos!!- TODO: Punkt entfernen?
